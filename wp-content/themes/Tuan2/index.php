...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/build/style_index.css" />
...
<body>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <li><a href="/privacy.php">Programs</a></li>
  ...
  <div class="page-banner">
    <div class="page-banner__bg-image"
      style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/library-hero.jpg)"></div>
